        ...
        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a class="nav-link">Sistema gestión de archivos</a>
                </li>
            </ul>
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        <img src="{{ asset('dist/img/user2-160x160.png') }}" class="img-circle elevation-2"
                            alt="User Image">
                    </div>
                    <div class="info">
                    ...
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        @can('usuarios.index')
                            <li class="nav-item">
                                <a href="{{ url('/') }}" class="nav-link active">
                                    <i class="nav-icon fas"><i class="bi bi-window"></i></i>
                                    <p>
                                        Panel principal
                                    </p>
                                </a>
                        ...
                        <li class="nav-item">
                            <a href="{{ url('/admin/mi_unidad') }}" class="nav-link active">
                                <i class="nav-icon fas"><i class="bi bi-database"></i></i>
                                <p>
                                    Mi unidad
                                </p>
                            </a>
