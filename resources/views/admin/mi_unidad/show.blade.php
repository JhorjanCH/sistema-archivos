...
@section('content')
                ...
                <div class="modal fade" id="modal_cargar_archivos" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class="modal-dialog modal-dialog-centered">
                        <div class="modal-content">
                            ...
                            <form action="{{ url('/admin/mi_unidad/carpeta/upload') }}" method="post" class="dropzone"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <input type="text" value="{{ $carpeta->id }}" name="carpeta_padre_id"
                                                    hidden>
                        ...
                        <div class="col-2" style="margin-top: 7px" style="text-align: right">
                            <div class="btn-group" role="group">
                                ...
                                <div style="margin-right: 300px" class="dropdown-menu">
                                    ...
                                    <a class="dropdown-item" href="#"><i class="bi bi-front"></i> Color de la
                                        carpeta
                                        <div class="btn-group" role="group" aria-label="Basic example">
                                            <form action="{{ url('/admin/mi_unidad/color') }}" method="post">
                                                ...
                                                <input type="text" value="{{ $subcarpeta->id }}" name="id"
                                                    hidden>
                                    ...
                                    <form action="{{ url('/admin/mi_unidad/eliminar_subcarpeta', $subcarpeta->id) }}"
                                        onclick="preguntar_d{{ $subcarpeta->id }}(event)"
                                        id="miFormularioC{{ $subcarpeta->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
                        ...
                        <div class="modal-body">
                            <form action="{{ url('/admin/mi_unidad/carpeta') }}" method="post">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" value="{{ $subcarpeta->nombre }}" class="form-control"
    ...
    <table id="tablaArchivos" class="table table-hover table-striped">
        ...
        <tbody>
            <input type="text" class="form-control w-25" id="buscador" onkeyup="buscarArchivos()"
                placeholder="Buscar archivos..."> <br>
            @php
                $contador = 0;
                $limite = 5; // Número de archivos por página
                $pagina = request()->get('page', 1); // Página actual, por defecto 1
                $tareasTotales = $archivos->count();
                $cantidadPaginas = ceil($tareasTotales / $limite);
                $items = $archivos->forPage($pagina, $limite);
            @endphp
            ...
            if ($extension == "jpg"){ ?>
                    ...
                    if ($extension == "docx") { ?><img src="{{ url('/imagenes//iconos/icono_de_word.png') }}" alt=""
                            width="25px"><?php }  
                    if ($extension == "pdf") { ?><img src="{{ url('/imagenes//iconos/icono_de_pdf.png') }}"
                            alt="" width="20px"><?php } 
                    if ($extension == "xlsx") { ?><img
                            src="{{ url('/imagenes//iconos/icono_de_xlsx.png') }}" alt=""
                            width="25px"><?php }
                    if ($extension == "pptx") { ?><img src="{{ url('/imagenes//iconos/icono_de_pptx.png') }}"
                            alt="" width="25px"><?php }
                    if ($extension == "mp4") { ?><img
                            src="{{ url('/imagenes//iconos/icono_de_video.png') }}" alt=""
                            width="25px"><?php }
                        ...
                        <div class="modal fade" id="modal_visor{{ $archivo->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <iframe src="{{ asset('storage/' . $carpeta->id . '/' . $archivo->nombre) }}"
                        ...
                        <div class="modal fade" id="modal_visor{{ $archivo->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <img src="{{ url('imagenes/iconos/icono_de_word.png') }}" width="50%"
                                            alt=""><br>
                                        <a href="{{ asset('storage/' . $carpeta->id . '/' . $archivo->nombre) }}"
                        ...
                        <div class="modal fade" id="modal_visor{{ $archivo->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <img src="{{ url('imagenes/iconos/icono_de_pptx.png') }}" width="50%"
                                            alt=""><br><br>
                                        <a href="{{ asset('storage/' . $carpeta->id . '/' . $archivo->nombre) }}"
                                            class="btn btn-success">Descargar</a>
                                    </div>
                        ...
                        <div class="modal fade" id="modal_visor{{ $archivo->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <img src="{{ url('imagenes/iconos/icono_de_xlsx.png') }}" width="50%"
                                            alt=""><br>
                                        <a href="{{ asset('storage/' . $carpeta->id . '/' . $archivo->nombre) }}"
                                            class="btn btn-success">Descargar</a>
                                    </div>
                        ...
                        <div class="modal fade" id="modal_visor{{ $archivo->id }}" tabindex="-1"
                            ...
                            <div class="modal-dialog modal-dialog modal-xl">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body" style="text-align: center">
                                        <video id="my-video" style="width: 100%;" height="500px" class="video-js"
                    ...
                    <td>
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                            ...
                            <button class="btn btn-success btn-sm"
                                style="border-top-right-radius: 3px; border-bottom-right-radius: 3px;" data-toggle="modal"
                                data-target="#modal_compartir_{{ $archivo->id }}">
                            ...
                            if ( ($archivo->estado_archivo)=="PRIVADO" ) { ?>
                                            ...
                                            <form action="{{ route('mi_unidad.archivo.privado.publico') }}"
                                                method="post">
                                                @csrf
                                            ...
                                            <form action="{{ route('mi_unidad.archivo.publico.privado') }}"
                                                method="post">
                                                @csrf
                                                <input type="text" name="id" value="{{ $archivo->id }}" hidden>
                                            ...
                                            <input type="text" id="foo{{ $archivo->id }}"
                                                value="{{ asset('storage/' . $carpeta->id . '/' . $archivo->nombre) }}"
                                                class="form-control">
                                            <script>
